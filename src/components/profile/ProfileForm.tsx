            ...
            <div className="flex items-center gap-4">
                <div className="relative">
                    ...
                    <button
                        ...
                        className="absolute -bottom-1 -right-1 flex h-9 w-9 items-center justify-center rounded-full bg-primary text-white shadow hover:bg-primary-hover transition-colors disabled:opacity-50"
